...
public class C
{
    ...
    /*NOTE about masks:
      ...
      checks for presence
      of a flag in the
      final result whereas
      value & mask == value
      tests for the
      equality between the
      flag and the result.
      1001 0011 & 1000 0000 = 1000 0000;
      == 1000 0000 is true: mouse flag is present in tested value
      == 1001 0011 is true: mouse flag is only flag present in tested value*/
    //ENUMS//
