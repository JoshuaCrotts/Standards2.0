...
public abstract class StandardDraw {
	...
	/**
	 * Passed an image, draws it.
	 * If x and y are doubles, it casts them appropriately.
	 * @param image
	 * @param x
	 * @param y
	 */
	 ...
	 * @param x
	 * @param y
	 * @param font - String version of font (path), if null or "", it will be default.
	 * @param size
	 */
	 ...
	 * Makes it easier to draw using doubles
	 * One doesn't have to directly cast the variables themselves
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	...
	/**
	 * Draws the passed handler; it calls the render method from the handler
	 * and draws it.
