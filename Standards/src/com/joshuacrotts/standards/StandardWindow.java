...
/**
 * This class is the class that instantiates the Screen.
 * It takes four parameters: width, height, a title, and the Game class itself that will automatically be
 * added to the frame as a component due to it extending class once it is instantiated.
 * 
