...
public class MouseParticle extends StandardGameObject/* implements MouseListener*/{
	...
	public void mousePressed(MouseEvent e) {
		...
		for(int i = 0; i < NUM_OF_PARTICLES; i++)
			this.particleHandler.addEntity(new StandardParticle(x, y, 1d, this.particleHandler));
