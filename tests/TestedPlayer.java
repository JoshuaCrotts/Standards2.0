...
public class TestedPlayer extends StandardGame
{
    ...
    public void tick()
    {
        ...
        for ( int i = 0; i < 100; i ++ )
        {
            new DragParticle( player.getX(), player.getY(), 3, particleHandler, Color.BLUE );
        }

        //StandardHandler.Add(new DragParticle(player.getX(), player.getY(), 3f), this.particleHandler, 5);
