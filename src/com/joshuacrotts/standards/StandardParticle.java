...
/**
 * This is a StandardParticle class, it needs to be passed the StandardHandler
 * it will be placed in DIRECTLY; you cannot reference the StandardGame and use
 * it, for some reason. It is probably an issue with the passing-by-reference
 * problems and memory allocation.
 *
 * @author Joshua
 *
 */
