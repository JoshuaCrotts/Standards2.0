...
/**
 * This is an abstract class that will be only used to draw certain things,
 * retrieve special colors that were created by me.
 *
 * @author Joshua, Source For Colors: Wikipedia.
 *
 * Shades of Red: https://en.wikipedia.org/wiki/Shades_of_red Shades of Blue:
 * https://en.wikipedia.org/wiki/Shades_of_blue Shades of Green:
 * https://en.wikipedia.org/wiki/Shades_of_green Shades of Yellow:
 * https://en.wikipedia.org/wiki/Shades_of_yellow Shades of Orange:
 * https://en.wikipedia.org/wiki/Shades_of_orange Shades of Violet:
...
public abstract class StandardDraw
{
    ...
    /**
     * Passed an image, draws it. If x and y are doubles, it casts them
     * appropriately.
     *
     * @param image
     * @param x
     ...
     * @param x
     * @param y
     * @param font - String version of font (path), if null or "", it will be
     * default.
     * @param size
     */
    public static void text( String text, int x, int y, String font, float size, Color color )
    {
        ...
        {
            Renderer.setFont( new Font( "Arial", Font.TRUETYPE_FONT, ( int ) size ) );
        }
    ...
    /**
     * Draws a string to the screen with specified font and size
     */
    ...
    /**
     * Draws a rectangle at specified coordinates, Makes it easier to draw using
     * doubles One doesn't have to directly cast the variables themselves
     *
     * @param x
     * @param y
     * @param width
    ...
    /**
     * Draws the passed parameter wherever it should be.
     *
     * @param obj calls the specified obj's render method. Abstraction A1
     */
    ...
    /**
     * Draws the passed handler; it calls the render method from the handler and
     * draws it.
     *
     * @param handler - any handler, trails, particles, etc. Abstraction A1
     */
