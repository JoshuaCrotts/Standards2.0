 ...
 *
 * Listeners will need to be added into the constructor of this class. Add them
 * in the constructor directly, or add them in the method initIterators() or
 * initObjects(). These methods may make the game run slightly slower because it
 * presumes every object to bode a listener of some sort, which some may not.
 *
...
public abstract class StandardGame extends Canvas implements Runnable
{
    ...
    {
        this.window = new StandardWindow( width, height, title, this );
    ...
    /**
     * This game loop was provided by online sources, though there are many
     * examples of a game loop online.
     *
     * @author RealTutsGML
     */
    public void run()
    {
        ...
        while ( running )
        {
            ...
            lastTime = now;
            /*
             * If the amount of unprocessed ticks is or goes above one... Also
             * determines if the game should update or not/render. Approximately
            ...
            /*
             * This clause replaces the original methods of tick and render. One
             * can use tick and render exclusively.
             */
            if ( renderable )
            {
                frames ++;
    ...
    /**
     * This method should tick everything that needs to be updated via
     * positioning, mouse input, etc.
     */
