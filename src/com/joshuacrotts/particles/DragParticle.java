...
/**
 * This is the original pink particle code @Andrew made, however, it is now in
 * its own separate class so we can define different particle classes.
 *
 * KEEP IN MIND ***DO NOT ADD THIS TO A HANDLER; STANDARDPARTICLE ADDS IT FOR
 * YOU
 *
 ***
 * @author Joshua
