...
/**
 * Interface InputDevice - HIDs such as keyboards, mouses, and controllers
 * should implement this interface so that Commands may be linked to their
 * inputs.
 *
...
public interface InputDevice
{
    ...
    /**
     * Provides an interface by which the structures backing different input
     * devices can be modified without explicite knowledge of the device in
     * question.
     *
     * @return The byte array containing state and command info.
     */
     ...
     *
     * @return returns a mask indicating what type of device is being operated
     * on.
     */
     ...
     * @param type the type of information to be retrieved (see ENUMS in
     * Constants)
